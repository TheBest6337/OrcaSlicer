...
static std::vector<std::string> s_Preset_printer_options {
    ...
    "z_offset",
    "disable_m73", "preferred_orientation", "emit_machine_limits_to_gcode", "support_multi_bed_types","bed_mesh_min","bed_mesh_max","bed_mesh_probe_distance", "adaptive_bed_mesh_margin", "activate_adaptive_purge", "adaptive_purge_type"
    };
